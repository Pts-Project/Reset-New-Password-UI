  ...
  return (
    <div className="mycard">
      <div className="card auth-card " style={{ backgroundImage: `url(${reset})`, minWidth: "100%", minHeight: "100%", backgroundPosition: "centre", backgroundSize: "cover" }}>
        ...
        <h4><bold>PLATFORM</bold></h4>

        <div class="input-field col s12" style={{ marginTop: "130px" }}>
        ...
        <button style={{ borderRadius: "50px", marginTop: "100px", marginBottom: "30px" }} className="btn waves-effect #212121 grey darken-4" name="action" type="submit"
          onClick={() => PostData()}
        >
